...
extern void do_wss_handshake(int *sockfd, wss_session_t *session);
...
extern void http_response(int *sockfd, enum HttpStatus_Code code);
extern void upgrade_response(int *sockfd, enum HttpStatus_Code code, char *exp);
extern void handshake_response(int *sockfd, wss_header_t *header, enum HttpStatus_Code code);
